    ...
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="800px" OnRowCommand="GridView1_RowCommand" OnRowCreated="GridView1_RowCreated">
                <Columns>
                    <asp:BoundField DataField="EmployeeID" HeaderText="ID"></asp:BoundField>
                    ...
                    <asp:BoundField DataField="BirthDate" DataFormatString="{0:d}" HeaderText="BirthDate"></asp:BoundField>
        ...
        <h1></h1>
        <asp:GridView ID="FileList" runat="server" AutoGenerateColumns="False" OnRowCommand="FileList_RowCommand">
            <Columns>
                <asp:BoundField DataField="Name" HeaderText="檔案目錄" />
                <asp:TemplateField>
                    <ItemTemplate>
